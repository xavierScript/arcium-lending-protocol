...
pub mod lending_protocol {
    ...
    pub fn health_check_callback(
        ...
        output: ComputationOutputs<HealthCheckOutput>,
    ) -> Result<()> {
        let result = match output {
            ComputationOutputs::Success(HealthCheckOutput { field_0 }) => field_0,
    ...
    pub fn liquidation_callback(
        ...
        output: ComputationOutputs<LiquidationOutput>,
    ) -> Result<()> {
        let result = match output {
            ComputationOutputs::Success(LiquidationOutput { field_0 }) => field_0,
            _ => return Err(ErrorCode::AbortedComputation.into()),
        };
